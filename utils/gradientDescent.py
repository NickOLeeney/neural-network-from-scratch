...
def random_mini_batches(X, Y, mini_batch_size, seed):
    ...
    if m % mini_batch_size != 0:
        ...
        mini_batch_X = shuffled_X[:, -last_mini_batch_size:]
        mini_batch_Y = shuffled_Y[:, -last_mini_batch_size:]
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate, beta1, beta2, epsilon):
    ...
    for l in range(1, L + 1):
        ...
        parameters["W" + str(l)] = parameters["W" + str(l)] - learning_rate * v_corrected[
            "dW" + str(l)] / (
                                           np.sqrt(s_corrected["dW" + str(l)]) + epsilon)
        parameters["b" + str(l)] = parameters["b" + str(l)] - learning_rate * v_corrected[
            "db" + str(l)] / (
